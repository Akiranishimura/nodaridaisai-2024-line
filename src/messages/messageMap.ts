...
import performanceMessages from './performance.json';
export const messageMap = {
	...
	企画検索: [performanceMessages.performance],
	中庭ステージ: [performanceMessages.stage],
	講義棟企画: [performanceMessages.kougitou1_3, performanceMessages.kougitou4_6],
	屋外企画: [performanceMessages.outside, performanceMessages.outside_other],
} as const;
